import { getProfile, saveProfile, clearProfile, counts } from './storage.js?v=25';
...
async function registerServiceWorker() {
  ...
  try { await navigator.serviceWorker.register('./sw.js?v=25'); } catch (error) { console.warn('PWA service worker:', error); }
}
