import { getProfile, saveProfile, clearProfile, counts } from './storage.js?v=20';
...
async function registerServiceWorker() {
  ...
  try { await navigator.serviceWorker.register('./sw.js?v=20'); } catch (error) { console.warn('PWA service worker:', error); }
}
