import { getProfile, saveProfile, counts } from './storage.js?v=43';
import {
  initAccounts,
  getAccountState,
...
async function registerServiceWorker() {
  ...
  try { await navigator.serviceWorker.register('./sw.js?v=43'); } catch (error) { console.warn('PWA service worker:', error); }
}
