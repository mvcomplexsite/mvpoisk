...
import { getMovies, searchMovies } from './api.js?v=37';
import { imageAttrs, bindImageFallbacks } from './images.js?v=37';
import { getContinueWatching, dismissContinue } from './storage.js?v=37';
