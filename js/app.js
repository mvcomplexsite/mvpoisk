...
import { getMovies, searchMovies } from './api.js?v=32';
import { imageAttrs, bindImageFallbacks } from './images.js?v=32';
import { getContinueWatching, dismissContinue } from './storage.js?v=32';
